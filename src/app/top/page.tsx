...
export default async function TopPage() {
    const items = await fetchTopAnime();
    ...
    return (
        <div className="bg-[#0a0a0a] min-h-screen text-white font-sans selection:bg-white/30" dir="rtl">
            ...
            <main className="container mx-auto px-4 pt-32 pb-20 max-w-[1600px]">
                <h1 className="text-4xl sm:text-5xl font-black mb-10 text-white border-b border-indigo-500/30 pb-6 inline-block">
                    الأكثر شهرة
                </h1>
                <p className="text-gray-400 mb-8 -mt-6">تصفح أفضل الأنميات الحاصلة على أعلى التقييمات عالمياً.</p>
