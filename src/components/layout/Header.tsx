...
export function Header() {
  ...
  return (
    ...
    >
      <motion.div
        className={`pointer-events-auto relative flex items-center justify-between w-full max-w-7xl px-4 sm:px-5 lg:px-6 py-2.5 rounded-[2rem] sm:rounded-full border transition-all duration-500 will-change-[background-color,backdrop-filter] ${
          isScrolled ? 'bg-[#030014]/85 backdrop-blur-lg shadow-[#00F0FF]/15 shadow-2xl border-white/10' : 'bg-[#030014]/85 backdrop-blur-lg border-white/10 sm:bg-transparent sm:backdrop-blur-none sm:shadow-none sm:border-transparent'
        }`}
        initial={false}
      >
